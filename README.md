...
###Use
1) On the home page the user is presented with a set of filters for episode length and genre. [IMAGE]()
2) The results page has information on total series length, episode length, and different times to watch series based on viewing frequency. [IMAGE]()
3) Users may add shows to a cart above results  to compare different shows more easily.[IMAGE]()
4) A show detail page offers more information and links to streaming video providers. [IMAGE]()
